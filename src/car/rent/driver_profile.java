...
public class driver_profile extends javax.swing.JFrame {
...
//        table();
    ...
    public driver_profile(int driver_id) {
        initComponents();
        ID = driver_id;
        try {
            Connect();
...
//    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(driver_profile.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new driver_profile().setVisible(true);
            }
        });
    }
